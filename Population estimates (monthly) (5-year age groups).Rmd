...
```{r}
erp_sa2_1995_2023_asgs2016 <- as.data.table(read_csv("Population estimates data/5-year age groups/Yearly/erp_sa2_1995_2023_asgs2016.csv"))
erp_sa2_1995_2023_asgs2021 <- as.data.table(read_csv("Population estimates data/5-year age groups/Yearly/erp_sa2_1995_2023_asgs2021.csv"))
erp_suburb_1995_2023_asgs2016 <- as.data.table(read_csv("Population estimates data/5-year age groups/Yearly/erp_suburb_1995_2023_asgs2016.csv"))
erp_suburb_1995_2023_asgs2021 <- as.data.table(read_csv("Population estimates data/5-year age groups/Yearly/erp_suburb_1995_2023_asgs2021.csv"))
erp_lga_1995_2023_asgs2016 <- as.data.table(read_csv("Population estimates data/5-year age groups/Yearly/erp_lga_1995_2023_asgs2016.csv"))
erp_lga_1995_2023_asgs2021 <- as.data.table(read_csv("Population estimates data/5-year age groups/Yearly/erp_lga_1995_2023_asgs2021.csv"))
...
erp_monthly_suburb_1995_2023_asgs2021 <- erp_suburb_1995_2023_asgs2021[, compare_interpolations(.SD, boundary_name = "SUBURB_NAME"),
                                                                       by = SUBURB_NAME]
erp_monthly_lga_1995_2023_asgs2021 <- erp_lga_1995_2023_asgs2021[, compare_interpolations(.SD, boundary_name = "LGA_NAME"),
                                                                 by = LGA_NAME]
erp_monthly_lga_1995_2023_asgs2016 <- erp_lga_1995_2023_asgs2016[, compare_interpolations(.SD, boundary_name = "LGA_NAME"),
                                                                 by = LGA_NAME]
...
erp_monthly_suburb_1995_2023_asgs2021 <- merge(erp_monthly_suburb_1995_2023_asgs2021,
                                               ...
                                               by = c("Year", "SUBURB_NAME"))
erp_monthly_lga_1995_2023_asgs2016 <- merge(erp_monthly_lga_1995_2023_asgs2016,
                                            erp_lga_1995_2023_asgs2016[, .(Year, LGA_NAME, p_all)],
                                            by = c("Year", "LGA_NAME"))
erp_monthly_lga_1995_2023_asgs2021 <- merge(erp_monthly_lga_1995_2023_asgs2021,
                                            erp_lga_1995_2023_asgs2021[, .(Year, LGA_NAME, p_all)],
                                            by = c("Year", "LGA_NAME"))
...
erp_monthly_lga_1995_2023_asgs2016[, date := as.Date(sprintf("%d-%02d-01", Year, Month))]
erp_monthly_lga_1995_2023_asgs2021[, date := as.Date(sprintf("%d-%02d-01", Year, Month))]
...
```{r fig.height=8, fig.width=9, warning=FALSE, layout="l-body-outset"}
...
# compare_interpolations_plot(erp_monthly_lga_1995_2023_asgs2016, boundary_name = "LGA_NAME")
# compare_interpolations_plot(erp_monthly_lga_1995_2023_asgs2021, boundary_name = "LGA_NAME")
...
datasets <- list(
  ...
  LGA_16     = erp_monthly_lga_1995_2023_asgs2016,
  LGA_21     = erp_monthly_lga_1995_2023_asgs2021
)
...
create_monthly_erp <- function(dt, boundary_name) {
  ...
  } else if (boundary_name == "LGA_NAME") {
    temp_dt <- data.table(
      Year = year_part,
      Month = month_part,
      Date = dates$Date,
      LGA_NAME = dt[["LGA_NAME"]][1],
      LGA_CODE = dt[["LGA_CODE"]][1])
  }
...
erp_monthly_lga_1995_2023_asgs2016 <- erp_lga_1995_2023_asgs2016[, create_monthly_erp(.SD, boundary_name = "LGA_NAME"), by = LGA_NAME]
erp_monthly_lga_1995_2023_asgs2021 <- erp_lga_1995_2023_asgs2021[, create_monthly_erp(.SD, boundary_name = "LGA_NAME"), by = LGA_NAME]

# Save population estimates
write.csv(erp_monthly_sa2_1995_2023_asgs2016, "Population estimates data/5-year age groups/Monthly/erp_monthly_sa2_1995_2023_asgs2016.csv", row.names = FALSE)
write.csv(erp_monthly_sa2_1995_2023_asgs2021, "Population estimates data/5-year age groups/Monthly/erp_monthly_sa2_1995_2023_asgs2021.csv", row.names = FALSE)
write.csv(erp_monthly_suburb_1995_2023_asgs2016, "Population estimates data/5-year age groups/Monthly/erp_monthly_suburb_1995_2023_asgs2016.csv", row.names = FALSE)
write.csv(erp_monthly_suburb_1995_2023_asgs2021, "Population estimates data/5-year age groups/Monthly/erp_monthly_suburb_1995_2023_asgs2021.csv", row.names = FALSE)
write.csv(erp_monthly_lga_1995_2023_asgs2016, "Population estimates data/5-year age groups/Monthly/erp_monthly_lga_1995_2023_asgs2016.csv", row.names = FALSE)
write.csv(erp_monthly_lga_1995_2023_asgs2021, "Population estimates data/5-year age groups/Monthly/erp_monthly_lga_1995_2023_asgs2021.csv", row.names = FALSE)
