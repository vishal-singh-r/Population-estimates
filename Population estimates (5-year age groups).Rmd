---
title: "Population estimates (5-year age groups)"
description: |
  This article provides the steps to create population estimates for 5-year age group and sex combinations from 1995 to 2000 at SA2-level (Australia | 2021 boundaries) and 1995 to 2023 at suburb-level (Queensland, Australia | 2016 and 2021 boundaries)
author:
  - name: "Vishal Singh"
...
write.csv(erp_sa2_1995_2023_asgs2021, "Population estimates data/5-year age groups/Yearly/erp_sa2_1995_2023_asgs2021.csv", row.names = FALSE)
...
# Save SA2 estimates
write.csv(erp_sa2_1995_2023_asgs2016, "Population estimates data/5-year age groups/Yearly/erp_sa2_1995_2023_asgs2016.csv", row.names = FALSE)
...
write.csv(erp_suburb_1995_2023_asgs2021, "Population estimates data/5-year age groups/Yearly/erp_suburb_1995_2023_asgs2021.csv", row.names = FALSE)
...
# Save suburb estimates
write.csv(erp_suburb_1995_2023_asgs2016, "Population estimates data/5-year age groups/Yearly/erp_suburb_1995_2023_asgs2016.csv", row.names = FALSE)
