...
description: |
  This article provides the steps to create population estimates for age and sex combinations from 1995 to 2000 at SA2-level (Australia | 2021 boundaries) and 1995 to 2023 at suburb-level (Queensland, Australia | 2016 and 2021 boundaries)
author:
  - name: "Vishal Singh"
...
# Age groups
setnames(erp_sa2_2001_2023_asgs2021_m,
...
setnames(erp_sa2_2001_2023_asgs2021_f,
...
setnames(erp_sa2_2001_2023_asgs2021_p,
...
# erp_state_1995_2023[, `m_00_04` := rowSums(.SD[, paste0("m_", 0:4)])]
# erp_state_1995_2023[, `m_05_09` := rowSums(.SD[, paste0("m_", 5:9)])]
# erp_state_1995_2023[, `m_10_14` := rowSums(.SD[, paste0("m_", 10:14)])]
# erp_state_1995_2023[, `m_15_19` := rowSums(.SD[, paste0("m_", 15:19)])]
# erp_state_1995_2023[, `m_20_24` := rowSums(.SD[, paste0("m_", 20:24)])]
# erp_state_1995_2023[, `m_25_29` := rowSums(.SD[, paste0("m_", 25:29)])]
# erp_state_1995_2023[, `m_30_34` := rowSums(.SD[, paste0("m_", 30:34)])]
# erp_state_1995_2023[, `m_35_39` := rowSums(.SD[, paste0("m_", 35:39)])]
# erp_state_1995_2023[, `m_40_44` := rowSums(.SD[, paste0("m_", 40:44)])]
# erp_state_1995_2023[, `m_45_49` := rowSums(.SD[, paste0("m_", 45:49)])]
# erp_state_1995_2023[, `m_50_54` := rowSums(.SD[, paste0("m_", 50:54)])]
# erp_state_1995_2023[, `m_55_59` := rowSums(.SD[, paste0("m_", 55:59)])]
# erp_state_1995_2023[, `m_60_64` := rowSums(.SD[, paste0("m_", 60:64)])]
# erp_state_1995_2023[, `m_65_69` := rowSums(.SD[, paste0("m_", 65:69)])]
# erp_state_1995_2023[, `m_70_74` := rowSums(.SD[, paste0("m_", 70:74)])]
# erp_state_1995_2023[, `m_75_79` := rowSums(.SD[, paste0("m_", 75:79)])]
# erp_state_1995_2023[, `m_80_84` := rowSums(.SD[, paste0("m_", 80:84)])]
# erp_state_1995_2023[, `m_85_99` := rowSums(.SD[, paste0("m_", 85:100)])]
# erp_state_1995_2023[, `m_all` := rowSums(.SD[, paste0("m_", 0:100)])]
# 
# erp_state_1995_2023[, `f_00_04` := rowSums(.SD[, paste0("f_", 0:4)])]
# erp_state_1995_2023[, `f_05_09` := rowSums(.SD[, paste0("f_", 5:9)])]
# erp_state_1995_2023[, `f_10_14` := rowSums(.SD[, paste0("f_", 10:14)])]
# erp_state_1995_2023[, `f_15_19` := rowSums(.SD[, paste0("f_", 15:19)])]
# erp_state_1995_2023[, `f_20_24` := rowSums(.SD[, paste0("f_", 20:24)])]
# erp_state_1995_2023[, `f_25_29` := rowSums(.SD[, paste0("f_", 25:29)])]
# erp_state_1995_2023[, `f_30_34` := rowSums(.SD[, paste0("f_", 30:34)])]
# erp_state_1995_2023[, `f_35_39` := rowSums(.SD[, paste0("f_", 35:39)])]
# erp_state_1995_2023[, `f_40_44` := rowSums(.SD[, paste0("f_", 40:44)])]
# erp_state_1995_2023[, `f_45_49` := rowSums(.SD[, paste0("f_", 45:49)])]
# erp_state_1995_2023[, `f_50_54` := rowSums(.SD[, paste0("f_", 50:54)])]
# erp_state_1995_2023[, `f_55_59` := rowSums(.SD[, paste0("f_", 55:59)])]
# erp_state_1995_2023[, `f_60_64` := rowSums(.SD[, paste0("f_", 60:64)])]
# erp_state_1995_2023[, `f_65_69` := rowSums(.SD[, paste0("f_", 65:69)])]
# erp_state_1995_2023[, `f_70_74` := rowSums(.SD[, paste0("f_", 70:74)])]
# erp_state_1995_2023[, `f_75_79` := rowSums(.SD[, paste0("f_", 75:79)])]
# erp_state_1995_2023[, `f_80_84` := rowSums(.SD[, paste0("f_", 80:84)])]
# erp_state_1995_2023[, `f_85_99` := rowSums(.SD[, paste0("f_", 85:100)])]
# erp_state_1995_2023[, `f_all` := rowSums(.SD[, paste0("f_", 0:100)])]
# 
# erp_state_1995_2023[, `p_00_04` := rowSums(.SD[, paste0("p_", 0:4)])]
# erp_state_1995_2023[, `p_05_09` := rowSums(.SD[, paste0("p_", 5:9)])]
# erp_state_1995_2023[, `p_10_14` := rowSums(.SD[, paste0("p_", 10:14)])]
# erp_state_1995_2023[, `p_15_19` := rowSums(.SD[, paste0("p_", 15:19)])]
# erp_state_1995_2023[, `p_20_24` := rowSums(.SD[, paste0("p_", 20:24)])]
# erp_state_1995_2023[, `p_25_29` := rowSums(.SD[, paste0("p_", 25:29)])]
# erp_state_1995_2023[, `p_30_34` := rowSums(.SD[, paste0("p_", 30:34)])]
# erp_state_1995_2023[, `p_35_39` := rowSums(.SD[, paste0("p_", 35:39)])]
# erp_state_1995_2023[, `p_40_44` := rowSums(.SD[, paste0("p_", 40:44)])]
# erp_state_1995_2023[, `p_45_49` := rowSums(.SD[, paste0("p_", 45:49)])]
# erp_state_1995_2023[, `p_50_54` := rowSums(.SD[, paste0("p_", 50:54)])]
# erp_state_1995_2023[, `p_55_59` := rowSums(.SD[, paste0("p_", 55:59)])]
# erp_state_1995_2023[, `p_60_64` := rowSums(.SD[, paste0("p_", 60:64)])]
# erp_state_1995_2023[, `p_65_69` := rowSums(.SD[, paste0("p_", 65:69)])]
# erp_state_1995_2023[, `p_70_74` := rowSums(.SD[, paste0("p_", 70:74)])]
# erp_state_1995_2023[, `p_75_79` := rowSums(.SD[, paste0("p_", 75:79)])]
# erp_state_1995_2023[, `p_80_84` := rowSums(.SD[, paste0("p_", 80:84)])]
# erp_state_1995_2023[, `p_85_99` := rowSums(.SD[, paste0("p_", 85:100)])]
# erp_state_1995_2023[, `p_all` := rowSums(.SD[, paste0("p_", 0:100)])]

# Define your age groupings
age_groups <- list(
...
write.csv(erp_sa2_1995_2023_asgs2021, "Population estimates data/5-year age groups/erp_sa2_1995_2023_asgs2021.csv", row.names = FALSE)
...
n <- ncol(erp_sa2_proportions)
baseline <- erp_sa2_proportions[Year == 2011, .SD, .SDcols = c("SA2_NAME", names(erp_sa2_proportions)[3:n])]
...
for (col in names(erp_sa2_proportions)[3:n]) {
...
# Remove temporary objects
rm(n, baseline, base_col, col, ratio_cols, zero_cols_2011, sa2_to_modify, sa2_with_zero)
...
# Loop through sexes and age groups
for (sex in c("m", "f")) {
  for (age_label in names(age_groups)) {
    age_range <- age_groups[[age_label]]
    cols <- if (is.character(age_range)) {
      paste0(sex, age_range)
    } else {
      paste0(sex, age_range)
    }
    new_col <- paste0(sex, "_", age_label)
    # print(col)
    # print(new_col)
    erp_sa1_2011_2023_asgs2021[, (new_col) := rowSums(.SD), .SDcols = cols]
  }
}

# Total per sex
erp_sa1_2011_2023_asgs2021[, m_all := rowSums(.SD), .SDcols = c(paste0("m", 0:84), "m85+")]
erp_sa1_2011_2023_asgs2021[, f_all := rowSums(.SD), .SDcols = c(paste0("f", 0:84), "f85+")]

# Total population (persons)
for (age_label in names(age_groups)) {
  age_range <- age_groups[[age_label]]
  cols_m <- if (is.character(age_range)) paste0("m", age_range) else paste0("m", age_range)
  cols_f <- if (is.character(age_range)) paste0("f", age_range) else paste0("f", age_range)
  new_col <- paste0("p_", age_label)
  erp_sa1_2011_2023_asgs2021[, (new_col) := rowSums(.SD), .SDcols = c(cols_m, cols_f)]
}

# Total persons
erp_sa1_2011_2023_asgs2021[, p_all := rowSums(.SD),
                           .SDcols = c(paste0("m", 0:84), "m85+", paste0("f", 0:84), "f85+")]

# Remove individual age groups
erp_sa1_2011_2023_asgs2021[, c(paste0("m", 0:84), "m85+", paste0("f", 0:84), "f85+", "total") := NULL]

# Set column order
m_cols <- paste0("m_", names(age_groups))
f_cols <- paste0("f_", names(age_groups))
p_cols <- paste0("p_", names(age_groups))
m_cols <- c(m_cols, "m_all")
f_cols <- c(f_cols, "f_all")
p_cols <- c(p_cols, "p_all")
all_new_cols <- c(m_cols, f_cols, p_cols)
remaining_cols <- setdiff(names(erp_sa1_2011_2023_asgs2021), all_new_cols)
setcolorder(erp_sa1_2011_2023_asgs2021, c(remaining_cols, m_cols, f_cols, p_cols))
rm(all_new_cols, remaining_cols, m_cols, f_cols, p_cols, age_label, age_range, sex, cols, new_col, cols_m, cols_f)
...
erp_suburb_1995_2023_asgs2021[, m_all := rowSums(.SD), .SDcols = paste0("m_", age_cols)]
erp_suburb_1995_2023_asgs2021[, f_all := rowSums(.SD), .SDcols = paste0("f_", age_cols)]
erp_suburb_1995_2023_asgs2021[, p_all := rowSums(.SD), .SDcols = paste0("p_", age_cols)]

# Persons = males + females
for (age in age_cols) {
  erp_suburb_1995_2023_asgs2021[, (paste0("p_", age)) := rowSums(.SD), .SDcols = c(paste0("m_", age), paste0("f_", age))]
}
...
write.csv(erp_suburb_1995_2023_asgs2021, "Population estimates data/5-year age groups/erp_suburb_1995_2023_asgs2021.csv", row.names = FALSE)

# Remove temporary objects
rm(cg_sa1_2021_sal_2021, merged_data, pop_cols, col, age_cols, age)
```
...
age_cols <- c("00_04", "05_09", "10_14", "15_19","20_24", "25_29", "30_34", "35_39", "40_44", 
              "45_49", "50_54", "55_59",  "60_64", "65_69", "70_74", "75_79", "80_84", "85_99")
erp_suburb_1995_2023_asgs2016[, m_all := rowSums(.SD), .SDcols = paste0("m_", age_cols)]
erp_suburb_1995_2023_asgs2016[, f_all := rowSums(.SD), .SDcols = paste0("f_", age_cols)]
erp_suburb_1995_2023_asgs2016[, p_all := rowSums(.SD), .SDcols = paste0("p_", age_cols)]

# Persons = males + females
for (age in age_cols) {
  erp_suburb_1995_2023_asgs2016[, (paste0("p_", age)) := rowSums(.SD), .SDcols = c(paste0("m_", age), paste0("f_", age))]
}
...
# Save suburb estimates
write.csv(erp_suburb_1995_2023_asgs2016, "Population estimates data/5-year age groups/erp_suburb_1995_2023_asgs2016.csv", row.names = FALSE)

# Remove temporary objects
rm(cg_ssc_2016_sal_2021, merged_data, col, pop_cols, age_cols, age)
```
...
```{r}
# save.image("Population estimates data/5-year age groups/Population-estimates.RData")
# Not saving the .RData file as the size is more than 50MB (80.5MB) allowed by GitHub without adopting large file storage (lfs)
```
